...
import type { CloneRepoReq, Config, CreateTaskReq, CreateTaskResp, DiffResp, ErrorResponse, EventMessage, HarnessInfo, InputReq, PreferencesResp, Repo, RestartReq, StatusResp, SyncReq, SyncResp, Task, TaskListEvent, TaskToolInputResp, UsageResp, VoiceTokenResp, WebFetchReq, WebFetchResp } from "./types.gen";
