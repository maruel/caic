...
- `internal/cicache/cicache.go`: Package cicache provides a persistent cache for GitHub CI check-run results.
...
- `internal/github/github.go`: Package github provides a minimal GitHub REST API client for PR creation
